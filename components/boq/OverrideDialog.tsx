    ...
    try {
      const res = await fetch(`/api/projects/${projectId}/boq/overrides`, {
        ...
        body: JSON.stringify({
          ...
          field: "rate",
          originalValue: group.rate.toString(),
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6" onClick={(e) => e.stopPropagation()}>
        <h2 className="font-semibold text-gray-900 mb-4">Propose Rate Override</h2>
        ...
        <div className="space-y-3 text-sm mb-5">
          ...
          {group.rateCode && (
            <div className="flex justify-between">
              ...
              <span className="font-mono text-gray-700">{group.rateCode}</span>
            </div>
          )}
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-gray-700">{group.unit}</span>
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-gray-500 text-sm">NRS</span>
            <input
              type="number"
              min="0"
              step="0.01"
