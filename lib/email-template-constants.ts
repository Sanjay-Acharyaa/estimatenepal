...
export const TEMPLATE_TYPES = [
  ...
  "data_wiped",
  "churn_reason",
  "churn_thanks",  // sent ~1h after churn reason button click
  "nps",
] as const;
...
export const DEFAULT_BODIES: Record<TemplateType, string> = {
  ...
  reengagement_14: `
    ...
    <table cellpadding="0" cellspacing="0" style="margin:28px 0">
      <tr><td style="background:#1d4ed8;border-radius:8px">
        <a href="{{upgradeUrl}}" style="display:inline-block;padding:14px 32px;color:#ffffff;text-decoration:none;font-weight:600;font-size:15px">Come Back to Estimate Nepal &rarr;</a>
      </td></tr>
    </table>
    <p style="color:#94a3b8;font-size:13px;margin:24px 0 0;padding-top:24px;border-top:1px solid #f1f5f9">
  ...
  churn_thanks: `
    ...
    <table cellpadding="0" cellspacing="0" style="margin:28px 0">
      <tr><td style="background:#1d4ed8;border-radius:8px">
        <a href="https://estimatenepal.com/pricing" style="display:inline-block;padding:14px 32px;color:#ffffff;text-decoration:none;font-weight:600;font-size:15px">See Plans &rarr;</a>
      </td></tr>
    </table>
    <p style="color:#94a3b8;font-size:13px;margin:24px 0 0;padding-top:24px;border-top:1px solid #f1f5f9">
