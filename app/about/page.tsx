      ...
      <div className="min-h-screen bg-white font-sans">
        ...
        <div className="border-b border-gray-200 px-4 py-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1">About Estimate Nepal</h1>
            <p className="text-xs text-gray-500">Nepal&apos;s first purpose-built construction estimating platform.</p>
          </div>
        </div>
