      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-bold text-xl tracking-tight">NepaliEstimate</span>
          </div>
        </div>
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center">
          ...
          <p className="text-blue-200 text-lg mb-10 max-w-sm leading-relaxed">
            Create accurate BOQs, manage tenders, and collaborate with your team — all in one place.
          </p>
      ...
      <div className="w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-8">
            ...
            <span className="font-bold text-blue-700 text-lg">NepaliEstimate</span>
          </div>
          ...
          {resendMsg && (
            <div role="status" className="mb-5 p-3 bg-green-50 border border-green-200 text-green-700 rounded-lg text-sm">
              {resendMsg}
            </div>
          )}
